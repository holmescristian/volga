...
<div id="container">
    ...
    if (!isset($_SESSION["userLogin"])) {
        ...
        <div id="sidebar2">
            ...
            <p class="xxsmallText">Before you can use our Web site, you need an account.
                If you already have an account, login below. If not, click <a style="color:#000000" href="register.php">here</a>.</p>
            <form id="frmLogin" name="frmLogin" method="post" action="loginAction.php">
                <p><span class="xsmallText">Username</span><br />
                    <input name="txtEmail" type="text" class="xsmallText" id="txtUsername" /></p>
                <p><span class="xsmallText">Password</span><br />
                    <input name="txtPassword" type="password" class="xsmallText" id="txtPassword" /></p>
                    <input name="submit" type="submit" id="submit" value="Login" /></p>
            </form>
            <hr />
            <p class="smallText">
  ...
  <div id="mainContent">
    ...
    <p>Not really. But we still want you to buy books from us so we're offering 25% off your next order. Click <a href="">here</a> for details.</p>
    <h2>New reads... </h2>
