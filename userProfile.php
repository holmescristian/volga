...
<div id="container">
    ...
    <div id="mainContent">
        <?php
        echo "<h2>".$arr["fName"]." ".$arr["lName"]."</h2>";
        echo "<br>";
        echo "<h4>Email: ".$arr["email"]."</h4>";
        $query = "SELECT * FROM tblAddress WHERE id=".$_SESSION["userLogin"];
        if ($result = mysqli_query($link, $query)){
            $arr = mysqli_fetch_assoc( $result);
            echo "<h4>Address: ".$arr["streetAddress"]."</h4>";
            echo "<h4>City: ".$arr["city"]."</h4>";
            echo "<h4>State: ".$arr["state"]."</h4>";
            echo "<h4>Zip Code: ".$arr["zip"]."</h4>";
        }
        echo "<br>";
